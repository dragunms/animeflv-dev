...
const PolicyPageDesktop = () => {
    return (
        <div className='policy-page-desktop'>
                    ...
                    <div className='container'>
                        ...
                        <div className='main'>
                            <p className='main-content'>
                                La Política de Privacidad establece los términos en que AnimeFLV usa y protege la
                            ...
                            <h2 className='main-title'>Información que es recogida</h2>
                            <p className='main-content'>
                                ...
                                cuando sea necesario podrá ser requerida información específica para procesar algún
                                pedido o realizar una entrega o facturación.
                            </p>
                            <h2 className='main-title'>Uso de la información recogida</h2>
                            <p className='main-content'>
                                ...
                                dirección que usted proporcione y podrán ser cancelados en cualquier momento. AnimeFLV
                            ...
                            <h2 className='main-title'>Cookies</h2>
                            <p className='main-content'>
                                ...
                                personalizado de su web. Nuestro sitio web emplea las cookies para poder identificar las
                            ...
                            <h2 className='main-title'>Enlaces a Terceros</h2>
                            <p className='main-content'>
                            ...
                            <h2 className='main-title'>Control de su información personal</h2>
                            <p className='main-content'>
                                ...
                                nuestro boletín o publicidad usted puede cancelarla en cualquier momento. Esta compañía
                                no venderá, cederá ni distribuirá la información personal que es recopilada sin su
                                consentimiento, salvo que sea requerido por un juez con un orden judicial. AnimeFLV Se
                                reserva el derecho de cambiar los términos de la presente Política de Privacidad en
                                cualquier momento.
                            </p>
                        </div>
                    </div>
...
export default PolicyPageDesktop;
