...
const FilterProfileHorizontalListDesktop = ({title = '', icon = '', listOptions}) => {
    return (
        <div className='filter-profile-horizontal-list-desktop'>
            <div className='top'>
...
export default FilterProfileHorizontalListDesktop;
