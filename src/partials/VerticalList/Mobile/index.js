...
import {FaPlayCircle, FaAngleDown, FaPlay} from 'react-icons/fa';
...
const VerticalListMobile = () => {
    const [showList, setShowList] = useState(false);

    function handleChangeShowListOnClick() {
        setShowList(!showList);
    }

    return (
        <div className='vertical-list-mobile'>
            <div className='vertical-list-header' onClick={handleChangeShowListOnClick}>
                <div className='prefix-header-icon'>
                    <FaPlay />
                </div>
                <span className='header-title'>ANIMES EN EMISIÓN</span>
                <div className={`header-icon ${showList ? 'active' : ''}`}>
                    <FaAngleDown />
                </div>
            </div>
            {showList && (
...
export default VerticalListMobile;
